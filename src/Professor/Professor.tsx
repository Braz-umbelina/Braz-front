...
function Professor({ aoAutenticar }: Props) {
  ...
  return (
    <div className="bg-brand-claro text-brand-tinta dark:bg-brand-preto dark:text-brand-light font-sans min-h-screen flex items-center justify-center p-4 sm:p-8 selection:bg-brand-acao selection:text-black">
      <OndaProfessora />

      <div className="relative w-full max-w-5xl h-[36rem] rounded-[2rem] bg-white dark:bg-brand-preto shadow-[0_30px_80px_-30px_rgba(15,35,60,0.35)] dark:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] overflow-hidden flex">
