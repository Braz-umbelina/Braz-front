    ...
    return (
      <div className="relative flex-1 min-w-0 flex overflow-hidden">
        ...
        <div
          ...
          aria-hidden="true"
        />
        <main className="relative z-10 w-full lg:w-[46%] pt-8 lg:pt-24 px-4 sm:px-8 lg:px-12">
...
return (
  <div className="relative flex-1 min-w-0 flex overflow-hidden">
    ...
    <main
      ...
      className="relative z-10 w-full lg:w-[46%] flex flex-col justify-start pt-8 lg:pt-24 px-4 sm:px-8 lg:px-12 pb-8 overflow-y-auto lg:overflow-visible animate-fade-in"
    >
      ...
      <div className="flex flex-col items-start gap-1 min-h-[10rem] shrink-0">
      ...
      <div className="lg:hidden shrink-0 mt-8 rounded-3xl bg-brand-mata p-6">{acoes}</div>
    </main>
