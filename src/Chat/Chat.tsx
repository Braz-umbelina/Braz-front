...
function Chat({ token, aoSair }: Props) {
  ...
  return (
    <div className="bg-black text-brand-light font-sans h-screen flex flex-col selection:bg-brand-teal selection:text-white">
      <Cabecalho aula={aula} aoSair={aoSair} />

      <main className="flex-1 overflow-y-auto p-4 md:p-8 flex flex-col gap-8 max-w-3xl mx-auto w-full pb-32">
